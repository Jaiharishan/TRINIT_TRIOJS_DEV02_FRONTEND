      ...
      <div className='flex items-center justify-between'>
          ...
          <div className='h-screen w-full md:w-1/2 flex items-center justify-center'>
            ...
            <div className='flex flex-col items-center sm:w-4/6 w-96 px-3 py-5 rounded-lg'>
                ...
                <input value={email} onChange={e => setEmail(e.target.value)} className='border-2 bg-yellow-100 border-gray-800 px-4 py-2 w-full rounded-full outline-none mb-3' />

                <div className='self-start mb-1 ml-1'>Password</div>
                <input type='password' value={password} onChange={e => setPassword(e.target.value)} className='border-2 bg-yellow-100 border-gray-800 px-4 py-2 w-full rounded-full outline-none' />

                <button onClick={handleSubmit} type='button' className='border-2 bg-yellow-300 border-gray-800 px-8 py-2 rounded-full mt-7'>Login</button>
